(function() {
  ...
  gju.PointCluster = function(threshold){
      this.clusters = [];
      this.points = [];
  ...
  gju.PointCluster.prototype.addToClosestCluster = function(point) {
      ...
      if (clusterToAddTo) {
          ...
          var cluster = new gju.Cluster(this);
          cluster.addPoint(point);
          this.clusters.push(cluster);
      }
  };

  gju.PointCluster.prototype.getClusters = function(){
   ...
   * @ignore
   */
  gju.Cluster = function (PointCluster) {
   ...
   */
  gju.Cluster.prototype.addPoint = function(point) {
      if (!this.center) {
          this.center = point.geo;

      } else {
          var l = this.points.length + 1;
          var lat = (this.center.coordinates[0] * (l-1) + point.geo.coordinates[0]) / l;
          var lng = (this.center.coordinates[1] * (l-1) + point.geo.coordinates[1]) / l;
   ...
   */
  gju.Cluster.prototype.getPoints = function() {
      return this.points;
  };
   ...
   */
  gju.Cluster.prototype.getSize = function() {
